...
Not all fields apply to all note types. The following cross-table is the **single source of truth** for which fields are required (✅), optional (⬜), or not applicable (—) per document type.
...
- All notes MUST include every field marked ✅ for their document type before publishing
